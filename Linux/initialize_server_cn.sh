...
configure_ohmyzsh() {
    ...
    # 克隆 Oh My Zsh 仓库
    sudo -u $username git clone --depth=1 https://git.zhaozhipeng.com/izzp/ohmyzsh.git /home/$username/oh-my-zsh
    ...
    if [ ! -d "/home/$username/.oh-my-zsh/custom/plugins/zsh-autosuggestions" ]; then
        ...
        sudo -u $username git clone --depth=1 https://git.zhaozhipeng.com/izzp/zsh-autosuggestions.git /home/$username/.oh-my-zsh/custom/plugins/zsh-autosuggestions
    else
    ...
    if [ ! -d "/home/$username/.oh-my-zsh/custom/plugins/zsh-syntax-highlighting" ]; then
        ...
        sudo -u $username git clone --depth=1 https://git.zhaozhipeng.com/izzp/zsh-syntax-highlighting.git /home/$username/.oh-my-zsh/custom/plugins/zsh-syntax-highlighting
    else
...
configure_powerlevel10k() {
    ...
    if [ -d "/home/$username/.oh-my-zsh" ]; then
        ...
        git clone --depth=1 https://git.zhaozhipeng.com/izzp/powerlevel10k.git /home/$username/.oh-my-zsh/custom/themes/powerlevel10k
